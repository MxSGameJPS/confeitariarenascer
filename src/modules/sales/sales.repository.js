...
export async function findProductsForSale(productIds) {
  const params = new URLSearchParams({
    select: "id,name,price,price_configured,active,stock_control,stock_quantity,pricing_mode,available_internal",
