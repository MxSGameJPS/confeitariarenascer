...
const SELECT = "id,store_name,accepts_orders,delivery_fee,minimum_order,delivery_estimate_min,delivery_estimate_max,pickup_estimate_min,pickup_estimate_max,whatsapp,business_hours,delivery_regions,store_timezone,updated_at";
