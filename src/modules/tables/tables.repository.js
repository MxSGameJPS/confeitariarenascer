...
export async function listActiveTableVisits() {
  const params = new URLSearchParams({
    select: "id,table_id,status,opened_at,occupied_at",
    status: "in.(aberto,ocupado)",
    order: "opened_at.desc",
  });
  return supabaseServerRequest(`/rest/v1/table_visits?${params}`);
}
