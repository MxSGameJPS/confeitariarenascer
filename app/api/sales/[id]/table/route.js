...
import { linkCommandToTableController } from "@/src/modules/sales/sales.controller";
import { validateLinkCommandToTable, validateSaleId } from "@/src/modules/sales/sales.validation";
...
export async function POST(request, { params }) {
  try {
    ...
    return await linkCommandToTableController(
      validateSaleId(id),
      validateLinkCommandToTable(await request.json()),
      actor
    );
  } catch (error) {
